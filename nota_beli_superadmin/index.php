            ...
            <div class="card card-primary card-tabs mb-0">
              <div class="card-header p-0 pt-1">
                <ul class="nav nav-tabs" id="filter-tabs" role="tablist">
                  <li class="nav-item">
                    <a class="nav-link active" data-filter="" href="#tab-all" data-toggle="tab">Semua</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" data-filter="Lunas" href="#tab-lunas" data-toggle="tab">Lunas</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" data-filter="75%" href="#tab-75" data-toggle="tab">Dibayar 75%</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" data-filter="50%" href="#tab-50" data-toggle="tab">Dibayar 50%</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" data-filter="25%" href="#tab-25" data-toggle="tab">Dibayar 25%</a>
                  </li>
                </ul>
              </div>
            </div>
        ...
        <div class="card" style="border-top-left-radius: 0; border-top-right-radius: 0;">
          ...
          <div class="card-body">
            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              $panggil_data_user = mysqli_query($con, "SELECT tbl_notabeli.*, tbl_supplier.nama_supplier FROM tbl_notabeli, tbl_supplier WHERE tbl_notabeli.kode_supplier = tbl_supplier.kode_supplier") or die(mysqli_error($con));
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href="../detail_notabeli_superadmin/index.php?kode_nota=<?= $data['kode_nota'];?>" 
      ...
      <div class="modal-content">
        ...
        <form action="tambah.php" method="post">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              <label for="tgl_pembelian">tgl_pembelian</label>
              <input type="date" name="tgl_pembelian" class="form-control"
                     id="tgl_pembelian" required>
            </div>

            <div class="form-group">
              <label for="total_pembelian">total_pembelian</label>
              <input type="number" name="total_pembelian" class="form-control"
                     id="total_pembelian" placeholder="Masukan total pembelian" required>
            </div>
...
<script>
  ...
  $(document).ready(function() {
    ...
    $('#filter-tabs a').on('click', function (e) {
      ...
      // Kolom index 5 adalah kolom 'status'
