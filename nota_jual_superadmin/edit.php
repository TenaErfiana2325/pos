      ...
      <div class="container-fluid">
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">Edit Data Nota Jual</h3>
          </div>
          <div class="card-body">
            <?php 
            $kode_nota = @$_GET['kode'];
            ...
            $query = mysqli_query($con, "SELECT * FROM tbl_notajual WHERE kode_nota = '$kode_nota'") or die(mysqli_error($con));
            ...
            <form action="ubah.php" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <input type="date" name="tgl_penjualan" class="form-control" id="tgl_penjualan" value="<?= $data['tgl_penjualan']; ?>" required>
              </div>
              <div class="form-group">
                <label for="total_penjualan">Total Penjualan</label>
                <input type="number" name="total_penjualan" class="form-control" id="total_penjualan" value="<?= $data['total_penjualan']; ?>" placeholder="Masukkan Total Penjualan" required>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <textarea name="keterangan" class="form-control" id="keterangan" rows="3" placeholder="Masukkan Keterangan"><?= $data['keterangan']; ?></textarea>
              </div>
