      ...
      <div class="container-fluid">
        ...
        <div class="card">
          ...
          <div class="card-header">
            <h3 class="card-title">Data Detail Nota Beli (Kode Nota: <?= $kode_nota_get ?>)</h3>
          </div>
          ...
          <div class="card-body">
            ...
            <div class="mb-2">
              ...
              <a href="../nota_beli/index.php" class="btn btn-secondary">
            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              $panggil_data_user = mysqli_query($con, "SELECT * FROM tbl_detail_notabeli WHERE kode_nota = '$kode_nota_get'") or die(mysqli_error($con));
              ...
              <a href="hapus.php?urut=<?= $data['urut']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin menghapus item ini?')">
      ...
      <div class="modal-content">
        ...
        <form action="tambah.php" method="post">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <input type="text" name="kode_nota" maxlength="10" class="form-control"
                     value="<?= $kode_nota_get ?>" readonly required>
            </div>
            ...
            <div class="form-group">
              ...
              <select name="kode_brg" id="tambah_kode_brg" class="form-control" required>
                ...
                while ($d_brg = mysqli_fetch_array($q_brg)) {
                  echo '<option value="' . $d_brg['kode_brg'] . '" data-harga="' . $d_brg['rata_harga_beli'] . '">' . $d_brg['kode_brg'] . ' - ' . $d_brg['nama_brg'] . '</option>';
                }
                ?>
              </select>
            </div>
          ...
          <div class="form-group">
            ...
            <input type="number" name="jumlah" class="form-control" id="jumlah" placeholder="Masukan Jumlah" required>
          </div>
          ...
          <!-- Total Harga Beli (Manual Input) -->
          <div class="form-group">
            <label for="total_harga_beli">Total Harga Beli</label>
            <input type="number" name="total_harga_beli" class="form-control" id="total_harga_beli" placeholder="Masukan Total Harga Beli" required>
          </div>
      ...
      <div class="modal-content">
        ...
        <form action="ubah.php" method="post">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              <label for="harga_beli">Harga Beli</label>
              <input type="number" name="harga_beli" id="edit_harga" class="form-control"
                     placeholder="Harga Beli" readonly required>
            </div>

            <div class="form-group">
              <label for="total_harga_beli">Total Harga Beli</label>
              <input type="number" name="total_harga_beli" id="edit_total" class="form-control"
                     placeholder="Total Harga Beli" readonly required>
            </div>
...
<script>
  // Otomatis isi Harga Beli dan hitung Total saat Barang dipilih (Modal Tambah)
  ...
  $('#tambah_jumlah').on('input', function() {
    hitungTotalTambah();
  });
  ...
  // Otomatis isi Harga Beli dan hitung Total saat Barang dipilih (Modal Edit)
  ...
  $('#modal-edit').on('show.bs.modal', function(e) {
    ...
    $(e.currentTarget).find('#edit_harga').val(harga_beli);
