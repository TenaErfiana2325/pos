        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              $panggil_data_user = mysqli_query($con, "SELECT tbl_nota_beli.*, tbl_supplier.nama_supplier FROM tbl_nota_beli, tbl_supplier WHERE tbl_nota_beli.kode_supplier = tbl_supplier.kode_supplier") or die(mysqli_error($con));
