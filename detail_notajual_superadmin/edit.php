      ...
      <div class="container-fluid">
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">Edit Detail Nota Jual</h3>
          </div>
          <div class="card-body">
            <?php 
            $urut = @$_GET['urut'];
            ...
            // Mengambil data detail berdasarkan urut dan kode_nota
            $query = mysqli_query($con, "SELECT * FROM tbl_detail_notajual WHERE urut = '$urut'") or die(mysqli_error($con));
            ...
            <form action="ubah.php" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <select name="kode_brg" class="form-control" id="kode_brg" required>
                  ...
                  <?php 
                  $sql_brg = mysqli_query($con, "SELECT * FROM tbl_barang") or die(mysqli_error($con));
                  while ($brg = mysqli_fetch_array($sql_brg)) {
